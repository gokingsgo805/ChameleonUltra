...
Reads EM4100 card and displays ID in both hex and decimal formats.

Usage:
    python em4100_hex_to_decimal.py
"""
...
def analyze_card_id(hex_id):
    ...
    print(f"  {CY}Hexadecimal:{C0}  {CG}{hex_id.upper()}{C0}")
...
def main():
    """Main function"""
    print(f"\n{CG}╔════════════════════════════════════════════════════════════════════╗{C0}")
    print(f"{CG}║          EM4100 HEX TO DECIMAL CONVERTER                          ║{C0}")
    print(f"{CG}╚════════════════════════════════════════════════════════════════════╝{C0}\n")
    ...
    if len(sys.argv) > 1:
        ...
        # Show examples
        show_examples = input(f"{CG}Show example conversions? (y/n): {C0}").strip().lower()
        if show_examples == 'y':
            example_conversions()
